...
- [3. Movement Ecology Data Analysis in R](#3-movement-ecology-data-analysis-in-r)
    ...
    - [3.3 There and back again: Connecting PostGIS and R](#33-there-and-back-again-connecting-postgis-and-r)
        - [3.3.1 Topic 1: Using `RPostgreSQL`](#331-topic-1-using-rpostgresql)
            - [3.3.1.1 Import data from PostGIS](#3311-import-data-from-postgis)
                - [Exercise 1: Import steps as ltraj](#exercise-1-import-steps-as-ltraj)
            - [3.3.1.2 Export data to PostGIS](#3312-export-data-to-postgis)
                - [Exercise 2: Export ltraj to the data base as steps](#exercise-2-export-ltraj-to-the-data-base-as-steps)
            - [3.3.1.3 What about shapefiles?](#3313-what-about-shapefiles)
                - [Exercise 3: Import roads](#exercise-3-import-roads)
        - [3.3.2 Topic 2: Introducing `rpostgis`](#332-topic-2-introducing-rpostgis)
            - [3.3.2.1 Import data from PostGIS](#3321-import-data-from-postgis)
                - [Exercise 1: Import roads](#exercise-1-import-roads)
                - [Exercise 2: Export to PostGIS](#exercise-2-export-to-postgis)
            - [More of `rpostgis`](#more-of-rpostgis)
- [reclassify to new raster](#reclassify-to-new-raster)
- [send to database](#send-to-database)
    - [Closure…](#closure)
        - [3.3.X Keep it tidy: sf](#33x-keep-it-tidy-sf)
        - [3.3.X+! Let's not forget about trajectories: rpostgisLT](#33x-lets-not-forget-about-trajectories-rpostgislt)
...
GitHub, with the help of `devtools`; we also need to install the
...
### 3.3.1 Topic 1: Using `RPostgreSQL`
...
### 3.3.2 Topic 2: Introducing `rpostgis`
