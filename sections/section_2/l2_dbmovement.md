...
* **[2.15 Functions and triggers (supplementary material)](#c_2.15)**
  * [Timestamping changes in the database using triggers](#c_2.15.1)
  * [Automation of the GPS data association with animal](#c_2.15.2)
  * [Consistency checks on the deployments information](#c_2.15.3)
  * [Synchronization of *gps\_sensors\_animals* and *gps\_data\_animals*](#c_2.15.4)
  * [Automating the creation of points from GPS coordinates](#c_2.15.5)
  * [UTM zone of a given point in geographic coordinates](#c_2.15.6)
...
### <a name="c_2.15.1"></a>2.15Timestamping changes in the database using triggers
...
### <a name="c_2.15.2"></a>Automation of the GPS data association with animals
...
### <a name="c_2.15.3"></a>Consistency checks on the deployments information
...
### <a name="c_2.15.4"></a>Synchronization of *gps\_sensors\_animals* and *gps\_data\_animals*
...
### <a name="c_2.15.5"></a>Automating the creation of points from GPS coordinates
...
### <a name="c_2.15.6"></a>UTM zone of a given point in geographic coordinates
